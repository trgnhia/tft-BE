...
public interface ChampItemRecommendRepository extends JpaRepository<ChampItemRecommend, Long> {
    ...
    @Query("""
                ...
                order by c.priority asc, c.id desc
            """)
    List<ChampItemRecommend> findAllPublishedByChampionId(@Param("championId") Long championId);
    ...
    @Query("""
            ...
            order by c.priority asc, c.id desc
            """)
    List<ChampItemRecommend> findAllByChampionIdForCms(@Param("championId") Long championId);
